...
- [ ] T-001: Lock CH 01-32 meters as the non-regression baseline
...
- [ ] T-002: Add explicit meter stream classification helpers
...
- [ ] T-003: Isolate `/meters/1` dispatch to CH 01-32 only
...
- [ ] T-004: Keep `/meters/13` dispatch isolated to AUX/FX only
...
- [ ] T-005: Strengthen AUX/FX `/meters/13` offset tests
  Reqs: REQ-002, REQ-003, REQ-006, REQ-010, REQ-011
...
- [ ] T-007: Preserve meter request/renew performance characteristics
