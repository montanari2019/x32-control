---
name: http-services
description: "Documents HTTP service and adapter patterns, typed request wrappers, transport normalization, and error mapping. Use when building API services, adapters, mock transports, or consistent HTTP error handling."
---

# HTTP Services and Adapters
