---
name: eslint-prettier-formatting
description: "Documents ESLint and Prettier configuration conventions, formatting rules, conflict avoidance, and code style expectations. Use when adjusting lint rules, formatting files, or setting up quality scripts."
---
