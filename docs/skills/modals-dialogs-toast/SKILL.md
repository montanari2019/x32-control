---
name: modals-dialogs-toast
description: "Documents overlay architecture for modal providers, dialogs, alert dialogs, and toast notifications. Use when adding transient feedback, confirmation flows, custom overlays, or modal lifecycle behavior."
---
