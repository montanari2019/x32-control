...
description: "Documents Android release build setup for React Native, including Gradle versions, signing configs, build types, APK/AAB generation, local properties, keystores, and distribution troubleshooting. Use when preparing Android builds for homologation, sideload, or Google Play."
---

# Android Build AAB and APK
