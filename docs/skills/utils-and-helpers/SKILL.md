...
description: "Documents utility module conventions for storage, logging, analytics, device wrappers, validators, and common helper functions. Use when creating cross-feature utilities or deciding where reusable helpers belong."
---
