...
description: "Documents package scripts, CI variants, platform scripts, Husky, Jest, ESLint, TypeScript, CocoaPods automation, and tooling conventions. Use when adding or changing project scripts and developer tooling."
---
