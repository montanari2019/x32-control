---
name: services-and-auth
description: "Documents service modules for platform SDK integrations, authentication flows, biometric auth, social auth, logout, and secure storage boundaries. Use when moving SDK or auth logic out of React components into service layers."
---

# Services and Auth Integrations
