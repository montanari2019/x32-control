...
description: "Documents the local environment and commands for running the React Native app on Android and iOS, including prerequisites, pods, Metro, environment files, flavors, and troubleshooting. Use when setting up or debugging local app execution."
---
